...
${OBJECTDIR}/_ext/43898991/request_parser.o: ../../request_parser.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/43898991/request_parser.o ../../request_parser.cpp

${OBJECTDIR}/_ext/43898991/pub_sub_manager.o: ../../pub_sub_manager.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/43898991
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/43898991/pub_sub_manager.o ../../pub_sub_manager.cpp

${OBJECTDIR}/_ext/43898991/connection_manager.o: ../../connection_manager.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/43898991
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/43898991/connection_manager.o ../../connection_manager.cpp

${OBJECTDIR}/_ext/43898991/response.o: ../../response.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/43898991
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/43898991/response.o ../../response.cpp

${OBJECTDIR}/_ext/43898991/main.o: ../../main.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/43898991
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/43898991/main.o ../../main.cpp

${OBJECTDIR}/_ext/43898991/token_handler.o: ../../token_handler.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/43898991
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/43898991/token_handler.o ../../token_handler.cpp

${OBJECTDIR}/_ext/43898991/server_connection.o: ../../server_connection.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/43898991
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/43898991/server_connection.o ../../server_connection.cpp

${OBJECTDIR}/_ext/43898991/http_service.o: ../../http_service.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/43898991
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/43898991/http_service.o ../../http_service.cpp

${OBJECTDIR}/_ext/43898991/db_utils.o: ../../db_utils.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/43898991
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/43898991/db_utils.o ../../db_utils.cpp

${OBJECTDIR}/_ext/43898991/logger.o: ../../logger.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/43898991
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/43898991/logger.o ../../logger.cpp

${OBJECTDIR}/_ext/43898991/stream_exception.o: ../../stream_exception.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/43898991
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/43898991/stream_exception.o ../../stream_exception.cpp

${OBJECTDIR}/_ext/43898991/token_monitor.o: ../../token_monitor.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/43898991
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/43898991/token_monitor.o ../../token_monitor.cpp

${OBJECTDIR}/_ext/43898991/server_session.o: ../../server_session.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/43898991
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/43898991/server_session.o ../../server_session.cpp

${OBJECTDIR}/_ext/43898991/request_body.o: ../../request_body.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/43898991
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/43898991/request_body.o ../../request_body.cpp

${OBJECTDIR}/_ext/43898991/stream.o: ../../stream.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/43898991
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/43898991/stream.o ../../stream.cpp

${OBJECTDIR}/_ext/43898991/request.o: ../../request.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/43898991
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/43898991/request.o ../../request.cpp
